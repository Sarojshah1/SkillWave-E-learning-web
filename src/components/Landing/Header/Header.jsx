                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
                        <motion.a
                            ...
                            href="#join"
                            className="bg-primary text-white py-3 px-6 rounded-full shadow-lg hover:bg-secondary hover:shadow-xl transition-transform duration-300 ease-in-out"
                        >
                            Join for Free
                        </motion.a>
                        <motion.a
                            ...
                            href="#how-it-works"
                            className="bg-transparent border-2 border-white text-primary py-3 px-6 rounded-full shadow-lg hover:bg-secondary hover:border-secondary transition-transform duration-300 ease-in-out"
                        >
                            Watch How It Works
                        </motion.a>
                    </div>
